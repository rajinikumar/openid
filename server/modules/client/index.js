...
routes.get('/register', oidc.use('client'), function (req, res, next) {
...
routes.post('/register', oidc.use('client'), function (req, res, next) {
...
routes.get('', oidc.use('client'), function (req, res, next) {
...
routes.get('/:id', oidc.use('client'), function (req, res, next) {
  req.model.client.findOne({
    user: req.session.user,
    id: req.params.id
  }, function (err, client) {
